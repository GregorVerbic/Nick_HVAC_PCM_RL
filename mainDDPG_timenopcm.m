%% DDPG Agent for Non-PCM Environment
% The difference from mainDDPG_time is that the reset and step functions
% are different to handle the new thermal environment.

clear; clear Reset_time; clear Step_timenopcm;
Inputdata;
...
StepHandle = @(Action,LoggedSignals) Step_timenopcm(Action,LoggedSignals); % calculate reward and next observation 
